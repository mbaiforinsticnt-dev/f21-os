...
- CI proof: `.github/workflows/default-ime.yml` injects the same payloads into a writable AOSP emulator image, reboots, and verifies system-app placement, the granted permission, and `default_input_method` = tt9 with zero manual steps.
